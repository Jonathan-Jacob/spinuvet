...
export default class extends Controller {
  ...
  add(e) {
    ...
    tempNode.innerHTML = `<div class="flex justify-between items-center sm:ml-2 p-2 my-2 bg-white rounded border border-gray-300 shadow-sn">
      <div class="flex items-center gap-2 overflow-hidden">
        ...
        <div data-ingredient-id="${e.currentTarget.dataset.ingredientId}">${e.currentTarget.dataset.ingredientName}</div>
      </div>
      <div class="flex items-center gap-1">
        <a target="_blank" href="/admin/ingredients/${e.currentTarget.dataset.ingredientId}">
    ...
    this.selectedContainerTarget.appendChild(tempNode.firstChild);
  }
